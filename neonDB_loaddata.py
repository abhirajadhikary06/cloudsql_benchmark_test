...
db_url = os.getenv('NEONDB_DATABASE_URL') or "postgresql://neondb_owner:npg_FcKX2bE4fjrD@ep-noisy-base-a11sozpq-pooler.ap-southeast-1.aws.neon.tech/benchmark?sslmode=require&channel_binding=require"
